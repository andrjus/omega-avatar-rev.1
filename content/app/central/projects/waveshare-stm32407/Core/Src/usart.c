...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspInit 0 */
    ...
    PC11     ------> UART4_RX
    */
    GPIO_InitStruct.Pin = TX_DYNAMIXEL_Pin|RX_DYNAMIXEL_Pin;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PC11     ------> UART4_RX
    */
    HAL_GPIO_DeInit(GPIOC, TX_DYNAMIXEL_Pin|RX_DYNAMIXEL_Pin);
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(TX_485_GPIO_Port, TX_485_Pin);

    HAL_GPIO_DeInit(RX_485_GPIO_Port, RX_485_Pin);
