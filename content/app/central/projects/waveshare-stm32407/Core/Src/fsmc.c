...
void MX_FSMC_Init(void)
{
  ...
  */
  ...
  /* hnand1.Config */
  hnand1.Config.PageSize = NAND0_PAGE_SIZE;
  hnand1.Config.SpareAreaSize = NAND0_SPARE_AREA_SIZE;
  hnand1.Config.BlockSize = NAND0_BLOCK_SIZE;
  hnand1.Config.BlockNbr = NAND0_BLOCK_NUMBER;
  hnand1.Config.PlaneNbr = NAND0_PLAN_NUMBER;
  hnand1.Config.PlaneSize = NAND0_PLAN_SIZE;
